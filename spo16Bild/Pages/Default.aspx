...
<head>
    ...
    <script type="text/javascript">
        ...
        function getImage(imgid) {
            return "<img src='https://ecusolna.sharepoint.com/sites/amzaspo16-dev/spo16Bild/Forms/" + imgid ;
        }
            ...
            $(results).each(function () {
               // var formattedEventDate = moment(this.EventDate0).format("MMM  <br>  DD");
                items.push('<li id="' + 'spoList' + '">' +
                    // this.Title +
                    "<div id='" + "kCat" + "' href=\"" + hostweburl + "/blog/Lists/Posts/Post.aspx?ID=" + this.ID + "\" target=\"_blank\">" + getImage(this.PreviewOnForm) + "</div>" +
                    '</li>');
            });
